...
(function (k) {
    function E(a, b, e) {
        var c = a[0],
            ...
            d = "update" == e ? { checked: c.checked, disabled: c.disabled, indeterminate: "true" == a.attr("indeterminate") || "false" == a.attr("determinate") } : c[f];
        if (/^(ch|di|in)/.test(e) && !d) B(a, f);
        else if (/^(un|en|de)/.test(e) && d) v(a, f);
        else if ("update" == e) for (var l in d) d[l] ? B(a, l, !0) : v(a, l, !0);
    ...
    function B(a, b, e) {
        ...
        c.disabled && q(a, "cursor", !0) && f.find(".iCheck-helper").css("cursor", "default");
        f.addClass(y || q(a, b) || "");
    ...
    function v(a, b, e) {
        ...
        f.attr("role") && !l && f.attr("aria-" + (t ? "disabled" : "checked"), "false");
        f.addClass(x || q(a, u) || "");
    }
    function J(a, b) {
        a.data("iCheck") &&
            (a.parent().html(a.attr("style", a.data("iCheck").s || "")),
            b && a.trigger(b),
            a.off(".i").unwrap(),
            k('label[for="' + a[0].id + '"]')
                .add(a.closest("label"))
    ...
    k.fn.iCheck = function (a, b) {
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(a))
            return (
                ...
                c.each(function () {
                    var g = k(this);
                    "destroy" == a ? J(g, "ifDestroyed") : E(g, !0, a);
                    k.isFunction(b) && b();
                })
            );
        ...
        return c.each(function () {
            ...
            E(g, !0, "update");
            if (D.length)
                D.on("click.i mouseover.i mouseout.i touchbegin.i touchend.i", function (p) {
                    var n = p.type,
                        A = k(this);
                    if (!m.disabled) {
                        if ("click" == n) {
            ...
            g.on("click.i focus.i blur.i keyup.i keydown.i keypress.i", function (p) {
                ...
                else if (/us|ur/.test(n)) h["blur" == n ? "removeClass" : "addClass"](u);
            });
